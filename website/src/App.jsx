...
import { BookOpen, Settings, Zap, Terminal, Github, ArrowLeft, ArrowRight, Code, User, Menu, X, ChevronRight } from 'lucide-react';
...
const allDocs = [
  ...
  { id: 'ai-studio', title: 'From Google AI Studio', icon: <Zap size={20} />, path: '/docs/from-ai-studio.md', category: 'useful' },
